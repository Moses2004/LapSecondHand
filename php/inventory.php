...
// This query counts phones that are in stock (stock > 0) OR
// not associated with any 'pending', 'processing', 'shipped', 'ready_for_pickup', or 'delivered' order.
// This is a common way to infer 'available' if you don't have a direct 'status' column in 'phones' table.
